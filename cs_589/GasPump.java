public class GasPump {
	...
	// print out all attributes of a GasPump object
	public void printAttributes() {
		System.out.println("Rprice = " + this.getRprice());
		System.out.println("Sprice = " + this.getSprice());
		System.out.println("w = " + this.getW());
	...
	// helper methods to return attribute values
